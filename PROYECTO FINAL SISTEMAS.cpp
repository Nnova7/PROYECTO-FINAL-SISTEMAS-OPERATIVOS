...
//SIMULADOR DE PROCESOS, MEMORIA Y RECURSOS.
...
public:
    ...
    void representarMemoria(){
	    ...
	    cout<<"\x1b[37m";//Blanco
	    cout << "Tamano Total: " << total << " KB | Usada: " << usada << " KB | Libre: " << (total - usada) << " KB\n";
	    cout << "Bloques:\n";
    ...
    void imprimirBloques(){
        cout << "\x1b[38;5;140mBloques disponibles: \x1b[38;5;97m";
        for (int bloque : bloques){
        	cout<<"\x1b[37m";//Blanco
            cout << bloque << " KB ";
        }
...
void manejarInterrupcion(Proceso &p, Memoria &memoria){
    cout << "\x1b[38;5;147mInterrupcion\x1b[37m: Proceso " << p.pid << " finalizado.\n";
